...
(async () => { applyTheme(getStoredTheme()); loadBuildNumber(); ensureGlassIndicator(); moveGlassIndicator(); await setFeedTab('people'); await loadPeople(); await updateNotificationBadge(); })();
