...
function toggleImageViewerMenu(event) { if (event) event.stopPropagation(); document.getElementById('image-viewer-menu')?.classList.toggle('active'); }
document.getElementById('image-viewer-dots')?.addEventListener('click', toggleImageViewerMenu);
