...
document.getElementById('feed-tab-people')?.addEventListener('click', () => setFeedTab('people'));
document.getElementById('feed-tab-global')?.addEventListener('click', () => setFeedTab('global'));
...
function setFeedTab(tab) {
  ...
  document.getElementById('feed-tab-people')?.classList.toggle('active', feedTab === 'people');
  document.getElementById('feed-tab-global')?.classList.toggle('active', feedTab === 'global');
