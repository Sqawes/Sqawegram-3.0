  ...
  for (const post of posts) {
    ...
    html.push(`
      <article class="post" id="post-${post.id}">
        ...
        ${!post.image_path && Number(post.user_id) === currentUserId ? `<button class="post-delete-text" type="button" onclick="deletePostById(${post.id})">Удалить публикацию</button>` : ''}
